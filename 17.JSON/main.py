...
if __name__ == '__main__':
    ...
    dic2 = dict(
        ...
        json_list=json.dumps(py_list, indent=4),
        json_str=json.dumps(py_str, indent=4),
        json_int=json.dumps(py_int, indent=4),
        json_float=json.dumps(py_float, indent=4),
        json_T=json.dumps(py_T, indent=4),
        json_F=json.dumps(py_F, indent=4),
        json_N=json.dumps(py_N, indent=4)
    )
    pprint(dic2)
    # 4
    print('#4')
