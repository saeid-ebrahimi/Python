...
cursor.execute(sql, ("Saeid Interactive",))
connection.commit()
...
cursor.execute("SELECT id FROM courses WHERE name=?", ("Hello world", ))
print(cursor.fetchone())

cursor.execute("SELECT id FROM companies WHERE name=?", ("Saeid Interactive", ))
print(cursor.fetchone())
